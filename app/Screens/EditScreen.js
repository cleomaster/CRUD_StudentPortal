...
function EditScreen({ route, navigation }) {
    ...
    const [isCheckedPhysics, setCheckedPhysics] = useState(student.subjects[0] ? true : false);
    const [isCheckedComputer, setCheckedComputer] = useState(student.subjects[1] ? true : false);
    const [isCheckedBiology, setCheckedBiology] = useState(student.subjects[2] ? true : false);
    const [current, setCurrent] = useState(student.gender);
    const [selectedValue, setSelectedValue] = useState(student.country);
    ...
    async function submitForm() {
        ...
        try {
          ...
          Alert.alert("Student successfully updated.");
